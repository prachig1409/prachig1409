<html>
        <head><h1>ARP Top Source IP for Number Of Packets</h1>
...
<style>
 ...
 label {
   ...
   #log1{
		...
		$sql = "SELECT ARP_Source_ip, COUNT(ARP_Source_ip) FROM arp_sip1 GROUP BY ARP_Source_ip ORDER BY COUNT(ARP_Source_ip) DESC LIMIT 5";
